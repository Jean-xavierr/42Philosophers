...
static void		ft_flag_precision(t_pdata *data)
{
	int		i;
	int		len_nb;
	char	*s;
...
static void		ft_flag_width(t_pdata *data)
{
	int			len_nb;
	int			precision;
	int			width;
...
static void		ft_flag_zero(t_pdata *data)
{
	int		len_nb;
	int		precision;
	int		width;
...
static void		ft_flag_minus(t_pdata *data)
{
	int		len_nb;
	int		precision;
	int		precision_tmp;
